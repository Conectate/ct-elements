...
[![Published on npm](https://img.shields.io/npm/v/@conectate/components/ct-lit.svg)](https://www.npmjs.com/package/@conectate/components/ct-lit)

## Installation

```bash
npm install @conectate/components/ct-lit
```
...
```typescript
import { CtLit, html, customElement } from '@conectate/components/ct-lit';
