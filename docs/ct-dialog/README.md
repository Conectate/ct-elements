...
<div align="center">
	<a href="https://npmcharts.com/compare/@conectate/components/ct-dialog?minimal=true">
		<img alt="Downloads per month" src="https://img.shields.io/npm/dm/@conectate/components/ct-dialog.svg" height="20">
	</a>
	<a href="https://www.npmjs.com/package/@conectate/components/ct-dialog">
		<img alt="NPM Version" src="https://img.shields.io/npm/v/@conectate/components/ct-dialog.svg" height="20">
	</a>
	<a href="https://github.com/conectate/lit-ct-components/graphs/contributors">
		<img alt="Contributors" src="https://img.shields.io/github/contributors/conectate/lit-ct-components.svg" height="20">
	</a>
</div>
...
```sh
# npm
npm i @conectate/components/ct-dialog

# yarn
yarn add @conectate/components/ct-dialog

# pnpm
pnpm i @conectate/components/ct-dialog
```
...
```javascript
import { showCtDialog, closeCtDialog } from "@conectate/components/ct-dialog";
...
```javascript
import { showCtCardDialog } from "@conectate/components/ct-dialog";
...
```javascript
import { showCtLoading } from "@conectate/components/ct-dialog";
...
```javascript
import { showCtPrompt } from "@conectate/components/ct-dialog";
...
```javascript
import { showCtConfirm, showCtConfirmCupertino } from "@conectate/components/ct-dialog";
