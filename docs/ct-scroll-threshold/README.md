[![Published on NPM](https://img.shields.io/npm/v/@conectate/components/ct-scroll-threshold.svg)](https://www.npmjs.com/package/@conectate/components/ct-scroll-threshold)
...
[![Published on webcomponents.org](https://img.shields.io/badge/webcomponents.org-published-blue.svg)](https://webcomponents.org/element/@conectate/components/ct-scroll-threshold)
...
```bash
npm i --save @conectate/components/ct-scroll-threshold
# or
pnpm i @conectate/components/ct-scroll-threshold
# or for disk savers
pnpm add @conectate/components/ct-scroll-threshold
```
...
<html>
	<head>
		<script type="module">
			...
			// npm i -g vite && vite
			import '@conectate/components/ct-scroll-threshold/ct-scroll-threshold.js';
		</script>
	</head>
	<body>
