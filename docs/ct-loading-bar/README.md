[![Published on webcomponents.org](https://img.shields.io/badge/webcomponents.org-published-blue.svg)](https://www.webcomponents.org/element/@conectate/components/ct-loading-placeholder)
...
```sh
$ yarn add @conectate/components/ct-loading-placeholder
```

or

```sh
$ npm i @conectate/components/ct-loading-placeholder
```
...
```javascript
import '@conectate/components/ct-loading-placeholder/ct-loading-placeholder';
```
