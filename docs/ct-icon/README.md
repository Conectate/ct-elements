<div align="center">
	<h1>@conectate/components/ct-icon</h1>
	<a href="https://npmcharts.com/compare/@conectate/components/ct-icon?minimal=true">
		<img alt="Downloads per month" src="https://img.shields.io/npm/dm/@conectate/components/ct-icon.svg" height="20">
	</a>
	<a href="https://www.npmjs.com/package/@conectate/components/ct-icon">
		<img alt="NPM Version" src="https://img.shields.io/npm/v/@conectate/components/ct-icon.svg" height="20">
	</a>
...
```sh
# npm
npm i @conectate/components/ct-icon

# yarn
yarn add @conectate/components/ct-icon

# pnpm
pnpm i @conectate/components/ct-icon
```
