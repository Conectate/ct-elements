...
:host{
    border-radius:8px;
    display:block;outline:none;padding:8px;display: flex;flex-direction: row;align-items: center;cursor:pointer}
:host(:hover){background:#7c7c7c36}
.name{flex:1;white-space:pre-wrap;word-wrap:break-word}
a{color: inherit}
ct-icon{margin-right:8px;}
</style>
